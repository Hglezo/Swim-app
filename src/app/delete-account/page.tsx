      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col items-center">
        <div className="max-w-md w-full bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold text-gray-900 dark:text-white">Delete Account</h2>
          ...
          <div className="space-y-6 mt-8">
            <div className="bg-teal-50 dark:bg-teal-900/20 border-l-4 border-teal-500 p-4 rounded-r-md">
              <h3 className="text-lg font-medium text-teal-900 dark:text-teal-100 mb-2">Before you leave</h3>
              <p className="text-teal-700 dark:text-teal-300 mb-4">Have you considered:</p>
              <ul className="list-disc list-inside text-teal-700 dark:text-teal-300 space-y-2">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-4 rounded-md">
              <h3 className="text-lg font-medium text-red-800 dark:text-red-200 mb-2">What you'll lose</h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-md border-2 border-gray-300 dark:border-gray-600 px-3 py-2 
            ...
            <Link
              href="/profile"
              className="block text-center text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 font-medium transition-colors"
            >
